...
public class FavorVideoApi
{
    ...
    public FavorVideoApi(String cookie, String mid, String fid)
    {
        this.cookie = cookie;
        this.mid = mid;
        this.fid = fid;
    ...
    public ArrayList<JSONObject> getFavorvideo(int page) throws IOException
    {
        try
        {
            JSONArray jsonArray = new JSONObject((String) get("http://api.bilibili.com/x/space/fav/arc?vmid=" + mid + "&ps=30&fid=" + fid + "&tid=0&keyword=&pn=" + page + "&order=fav_time", 1)).getJSONObject("data").getJSONArray("archives");
