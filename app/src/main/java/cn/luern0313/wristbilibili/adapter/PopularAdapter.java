...
public class PopularAdapter extends BaseAdapter
{
    ...
    private final PopularAdapterListener popularAdapterListener;

    private final ArrayList<PopularModel.PopularVideoModel> popularVideoModelArrayList;
    private final ListView listView;

    public PopularAdapter(LayoutInflater inflater, ArrayList<PopularModel.PopularVideoModel> popularVideoModelArrayList, ListView listView, PopularAdapterListener popularAdapterListener)
    {
        mInflater = inflater;
        this.popularVideoModelArrayList = popularVideoModelArrayList;
        this.listView = listView;
        this.popularAdapterListener = popularAdapterListener;
    }

    @Override
    public int getCount()
    {
        return popularVideoModelArrayList.size();
    }
    ...
    {
        PopularModel.PopularVideoModel popularVideoModel = popularVideoModelArrayList.get(position);

        ViewHolder viewHolder;
        if(convertView == null)
        {
            convertView = mInflater.inflate(R.layout.item_popular, null);
            viewHolder = new ViewHolder();
            viewHolder.layout = convertView.findViewById(R.id.popular_item_video);
            viewHolder.video_img = convertView.findViewById(R.id.popular_item_video_img);
            viewHolder.video_time = convertView.findViewById(R.id.popular_item_video_time);
            viewHolder.video_title = convertView.findViewById(R.id.popular_item_video_video_title);
            viewHolder.video_play = convertView.findViewById(R.id.popular_item_video_video_play);
            viewHolder.video_danmaku = convertView.findViewById(R.id.popular_item_video_video_danmaku);
            viewHolder.video_reason = convertView.findViewById(R.id.popular_item_video_video_reason);
    ...
    {
        return v -> popularAdapterListener.onClick(v.getId(), position);
    }
