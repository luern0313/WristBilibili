...
public class PopularWeeklyAdapter extends BaseAdapter
{
    private final LayoutInflater mInflater;

    private final PopularWeeklyAdapterListener popularWeeklyAdapterListener;

    private final ArrayList<PopularWeeklyVideoListModel.PopularWeeklyVideoModel> popularWeeklyVideoModelArrayList;
    private final ListView listView;

    public PopularWeeklyAdapter(LayoutInflater inflater, ArrayList<PopularWeeklyVideoListModel.PopularWeeklyVideoModel> popularWeeklyVideoModelArrayList, ListView listView, PopularWeeklyAdapterListener popularWeeklyAdapterListener)
    {
        mInflater = inflater;
        this.popularWeeklyVideoModelArrayList = popularWeeklyVideoModelArrayList;
        this.listView = listView;
        this.popularWeeklyAdapterListener = popularWeeklyAdapterListener;
    }

    @Override
    public int getCount()
    {
        return popularWeeklyVideoModelArrayList.size();
    }
    ...
    {
        PopularWeeklyVideoListModel.PopularWeeklyVideoModel popularVideoModel = popularWeeklyVideoModelArrayList.get(position);

        ViewHolder viewHolder = null;
        if(convertView == null)
        {
            convertView = mInflater.inflate(R.layout.item_popular_weekly, null);
            viewHolder = new ViewHolder();
            viewHolder.layout = convertView.findViewById(R.id.popular_weekly_item_video);
            viewHolder.video_img = convertView.findViewById(R.id.popular_weekly_item_video_img);
            viewHolder.video_time = convertView.findViewById(R.id.popular_weekly_item_video_time);
            viewHolder.video_title = convertView.findViewById(R.id.popular_weekly_item_video_video_title);
            viewHolder.video_play = convertView.findViewById(R.id.popular_weekly_item_video_video_play);
            viewHolder.video_danmaku = convertView.findViewById(R.id.popular_weekly_item_video_video_danmaku);
            viewHolder.video_reason = convertView.findViewById(R.id.popular_weekly_item_video_video_reason);
    ...
    {
        return v -> popularWeeklyAdapterListener.onClick(v.getId(), position);
    }
    ...
    public interface PopularWeeklyAdapterListener
    {
