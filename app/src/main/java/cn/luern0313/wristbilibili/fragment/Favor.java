...
import cn.luern0313.wristbilibili.api.FavourApi;
    ...
    void getFavorbox()
    {
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    favourApi = new FavourApi(MainActivity.sharedPreferences.getString("cookies", ""), MainActivity.sharedPreferences.getString("mid", ""));
                    favourboxArray = favourApi.getFavorbox();
